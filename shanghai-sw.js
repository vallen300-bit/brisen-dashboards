...
const CACHE = 'shanghai-trip-room-v2';
const OWN = ['shanghai-september-2026.html','shanghai.webmanifest','shanghai-icon-192.png','shanghai-icon-512.png','shanghai-icon-180.png'];
